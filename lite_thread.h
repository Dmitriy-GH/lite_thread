...
Если зарегистрирован хоть один тип сообщения, то в метод recv() будут передаваться только они, остальные 
будут игнорироваться с сообщением об ошибке.
...
Ресурс ограничивает сколько может быть запущено одновременно акторов привязынных к ресурсу.
